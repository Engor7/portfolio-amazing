   ...
   >
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
         <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M17.92 11.7a9.83 9.83 0 0 1 2.33 6.11c0 3.631-3.694 5.379-8.25 5.379s-8.25-1.748-8.25-5.379a9.84 9.84 0 0 1 2.334-6.11"
         />
         <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 18a1.875 1.875 0 1 0 0-3.75A1.875 1.875 0 0 0 12 18"
         />
         <path d="M13.875 8.25a.375.375 0 0 1 0-.75m0 .75a.375.375 0 0 0 0-.75m-3.75.75a.375.375 0 1 1 0-.75m0 .75a.375.375 0 0 0 0-.75" />
         <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M17.25 1.609a.857.857 0 0 0-1.394-.67L14.3 2.792A7.3 7.3 0 0 0 12 2.4a7.3 7.3 0 0 0-2.295.394L8.144.939a.858.858 0 0 0-1.394.67c0 7.406-1.5 2.593-1.5 8.082c0 2.842 3.75 3.75 6.75 3.75s6.75-.908 6.75-3.75c0-5.478-1.5-.691-1.5-8.082"
         />
         <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M5.778 6.62A3.068 3.068 0 0 0 .75 8.941v2.25a4.96 4.96 0 0 0 3.316 4.369M18.2 12.033a4.5 4.5 0 0 1 5.05 4.467v2.191a2.25 2.25 0 0 1-2.25 2.25h-1.989"
         />
      </g>
   </svg>
);
